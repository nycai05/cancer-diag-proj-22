...
params = { 'max_depth': [6], 
          'learning_rate': [0.058, 0.06, 0.062],
...
filename='xgb_prolaris_aprstat.csv'
...
filename='xgb_prolaris_cmatrix.csv'
with open(filename, 'w', newline="") as file:
    csvwriter = csv.writer(file)
    csvwriter.writerows(cmatrix)
    
filename='xgb_prolaris_best_params.csv'
with open(filename, 'w', newline="") as file:
    csvwriter = csv.writer(file)    
