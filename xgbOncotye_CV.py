...
#read data
filename='gexp2oncotypeDX.csv'  # expression values 31 genes in 145 samples and class lables
...
filename='xgb_oncotype_aprstat.csv'
...
filename='xgb_oncotype_cmatrix.csv'
with open(filename, 'w', newline="") as file:
    csvwriter = csv.writer(file)
    csvwriter.writerows(cmatrix)
    
filename='xgb_oncotype_best_params.csv'
with open(filename, 'w', newline="") as file:
    csvwriter = csv.writer(file)    
